...
def main(cfg):
    ...
    model.optimizer.add_param_group({'params': proxies, 'lr': float(base_lr) * 100})
    ...
    scheduler_loss = collections.deque(maxlen=1000)
    cnt = 0
...
if __name__ == "__main__":
    ...
    # try except keyboardinterrupt lets us save the model just bsurfaceefore the program stops
